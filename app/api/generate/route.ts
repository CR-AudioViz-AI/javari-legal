// app/api/generate/route.ts — javari-legal
...
const SYSTEM = `You are a legal document assistant. Create contracts, agreements, business documents. Always note: consult an attorney for legal advice.`; const ACTIONS = ["nda", "contract", "privacy_policy", "terms_of_service", "employment_agreement", "partnership_agreement"]; const COST = 8
