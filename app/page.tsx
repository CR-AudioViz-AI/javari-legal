"use client";
// app/page.tsx — Javari Legal · CR AudioViz AI · EIN 39-3646201 · May 2026
import { useState } from "react";
const T=[{"i": "\ud83d\udccb", "l": "Contract Draft", "d": "Contract templates", "h": "/contract"}, {"i": "\ud83d\udce7", "l": "Client Letter", "d": "Professional communications", "h": "/letter"}, {"i": "\ud83d\udcdd", "l": "Demand Letter", "d": "Demand letter drafts", "h": "/demand"}, {"i": "\ud83d\udd0d", "l": "Legal Research", "d": "Case law summaries", "h": "/research"}];
export default function P() {
  ...
  async function go() { if(!i.trim())return; setL(true);setO("");
    try { const r=await fetch("/api/chat",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({messages:[{role:"user",content:i}],stream:false,systemOverride:"You are a legal writing assistant. Draft clear documents. Always include: not legal advice, consult a licensed attorney."})});
  ...
  return (<div style={{minHeight:"100vh",background:"#040912",color:"#e2e8f0",fontFamily:"system-ui"}}>
    ...
    <section style={{background:"linear-gradient(135deg,#1E3A5F,#040912)",padding:"48px 24px 40px",textAlign:"center"}}>
      <h1 style={{fontSize:"clamp(22px,4vw,42px)",fontWeight:900,color:"#fff",margin:"0 0 10px",lineHeight:1.05}}>AI Legal<br/><span style={{color:"#FF0800"}}>Writing Tools</span></h1>
      <p style={{color:"rgba(255,255,255,0.7)",fontSize:15,margin:0}}>Document drafts, client letters, and law firm marketing.</p>
    </section>
